...
CM_list <- list(xgbCM, elastinetCM, c5CM, knnCM, svmCM, avNNCM)

compiled_results <- tibble(
    models = c('xgb','elastinet','C5.0','knn','svm', 'avgNN'),
...
xyplot(kappa~F1,compiled_results,
       panel = function(...){
           ...
           ltext(...,labels=compiled_results$models,
                 pos=4, cex=.9, offset = .6,col='darkblue')
       }, xlim=seq(0.6,0.9,0.05), type=c('p','g','r'), col.line='gray',
       lty = 2, main = 'Kappa vs F1 (Test Set Performance)')
```
