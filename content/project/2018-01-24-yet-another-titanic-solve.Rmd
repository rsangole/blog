...
CM_list <- list(xgbCM, xgbredCM, elastinetCM, c5CM, knnCM, svmCM)

compiled_results <- tibble(
    models = c('xgb','xgb_reduced','elastinet','C5.0','knn','svm'),
