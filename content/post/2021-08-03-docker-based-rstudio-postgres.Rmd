...
What's in [`docker-compose.yml`](https://github.com/rsangole/postgres/blob/master/docker-compose.yml)? We're creating two services, one called `db` and the other `rstudio`.[^3]

[^3]: These are just labels, you can call them what you'd like
